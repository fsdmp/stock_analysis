...
| 技术指标 | MA（5/7/10/20）、VWMA（5/10/20）、BB（20日布林带）、MACD（12/26/9）、KDJ（9/3/3）、OBV、量比 |
| 短线评分 | 10 维度趋势上下文评分引擎，tanh 非线性归一化，输出 0~100 综合评分与操作建议 |
...
| 量价配合 | **18** | 验证一切价格运动的真伪 |
| MA 趋势 | 12 | 方向判断 + VWMA 反诱多 |
| 主力行为 | **12** | 识别主力操纵痕迹 |
| MACD 动能 | 10 | 有用但滞后 |
| KDJ 状态 | 10 | 趋势上下文化后价值大增 |
| 支撑压力 | 8 | 近期关键价位参考 |
| 背离信号 | 5 | 小概率但高价值信号 |
| 均线形态 | 3 | 前兆指标，非行动指标 |
| 趋势确认 | 2 | Meta 层面一致性检验 |
...
| GET | `/api/score/<code>` | 短线评分（10维度趋势上下文评分） |
